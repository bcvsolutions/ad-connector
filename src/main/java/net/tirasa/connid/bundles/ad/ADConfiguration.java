...
public class ADConfiguration extends LdapConfiguration {
    ...
    private boolean retrievePrimaryGroupDn = false;
    
    private boolean retrieveDefaultAttributes = true;
    
    private String[] extensionAttToGet = {};

    @ConfigurationProperty(order = 20, displayMessageKey = "pagesize.display",
    ...
    public ADConfiguration() {
        ...
        setPort(636);
        setExtensionAttToGet(new String[] { LdapConstants.LDAP_GROUPS_NAME, SAMACCOUNTNAME });
    ...
    public void setAccountSearchObjectClasses(String[] accountSearchObjectClasses) {
        this.accountConfig.setLdapClasses(Arrays.asList(accountSearchObjectClasses));
    }

    @ConfigurationProperty(displayMessageKey = "Account search object classes",
        helpMessageKey = "Specify which object classes will be used in LDAP filter when performing search operation", order = 128)
    public String[] getAccountSearchObjectClasses() {
       String [] result = new String[accountConfig.getLdapClasses().size()];
       accountConfig.getLdapClasses().toArray(result);
       return result;
    }
    ...
    @ConfigurationProperty(displayMessageKey = "retrievePrimaryGroupDn.display",
            helpMessageKey = "retrievePrimaryGroupDn.help", order = 18)
    public boolean isRetrievePrimaryGroupDn() {
        return retrievePrimaryGroupDn;
    }

    public void setRetrievePrimaryGroupDn(final boolean retrievePrimaryGroupDn) {
        this.retrievePrimaryGroupDn = retrievePrimaryGroupDn;
    }
    
    @ConfigurationProperty(displayMessageKey = "retrieveDefaultAttributes.display",
            helpMessageKey = "retrieveDefaultAttributes.help", order = 18)
    public boolean isRetrieveDefaultAttributes() {
        return retrieveDefaultAttributes;
    }

    public void setRetrieveDefaultAttributes(final boolean retrieveDefaultAttributes) {
        this.retrieveDefaultAttributes = retrieveDefaultAttributes;
    }
    
    public void setExtensionAttToGet(String... extensionAttToGet) {
    	this.extensionAttToGet = new String[extensionAttToGet.length];
    	System.arraycopy(extensionAttToGet, 0, this.extensionAttToGet, 0, extensionAttToGet.length);
    }

    @ConfigurationProperty(displayMessageKey = "extensionAttToGet.display",
        helpMessageKey = "extensionAttToGet.help", order = 129)
    public String[] getExtensionAttToGet() {
	    if (extensionAttToGet != null && extensionAttToGet.length > 0) {
	        // return specified configuration
	    	String[] attToGet = new String[extensionAttToGet.length];
	    	System.arraycopy(extensionAttToGet, 0, attToGet, 0, extensionAttToGet.length);
	    	return attToGet;
	    } else {
	        return null;
	    }
