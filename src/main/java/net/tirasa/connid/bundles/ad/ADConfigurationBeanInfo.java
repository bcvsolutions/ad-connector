...
public class ADConfigurationBeanInfo extends SimpleBeanInfo {
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
        ...
        try {
            ...
            props.add(new PropertyDescriptor("pageSize", ADConfiguration.class));
            ...
            // account search object classes
            props.add(new PropertyDescriptor("accountSearchObjectClasses", ADConfiguration.class));
            ...
            // retrieve primary group dn with memberOf/ldapGroups
            props.add(new PropertyDescriptor("retrievePrimaryGroupDn", ADConfiguration.class));
            
            // retrieve default attributes
            props.add(new PropertyDescriptor("retrieveDefaultAttributes", ADConfiguration.class));
            
            // add more attributes to get
            props.add(new PropertyDescriptor("extensionAttToGet", ADConfiguration.class));
